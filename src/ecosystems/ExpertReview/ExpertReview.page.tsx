...
import Image from '../../assets/images/daniel_photo.png';
import styled from 'styled-components';
import ListGroup from 'react-bootstrap/ListGroup';
import CONFIG from '../../config';
import { formatDate } from '../../utils/utils';

class ExpertReviewPage extends React.Component<RouteComponentProps> {
    public render() {
        return (
            <Container>
                <Row>
                    ...
                    <Col>
                        <Wrapper>
                            <Card>
                                ...
                                <Card.Body>
                                    <Card.Title>Daniel Craig</Card.Title>
                                </Card.Body>
...
export default withRouter(ExpertReviewPage);
