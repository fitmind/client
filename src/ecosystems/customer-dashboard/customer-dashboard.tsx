...
import { fetchCustomerUserAction } from './customer-dashboard.actions';
...
const CustomerDashboard: React.FC<CustomerDashboardPageAllProps> = ({ customerUser, fetchCustomerUserAction }) => {
    useEffect(() => {
